...
public class LuancherPersistentSerializer {
    ...
    public static void main(String[] args) throws CachePersistenceException {
        destroyCache();
        buildPersistenceStorageCache(Integer.class, Person.class);
    ...
    public static void buildPersistentMyCache(String cacheName) {
        Cache myCache = persistentCacheManager.getCache(cacheName, Integer.class, Person.class);
